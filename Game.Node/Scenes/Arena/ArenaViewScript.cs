...
public partial class ArenaViewScript : Control
{
    ...
    private void InitUI()
    {
        ...
        _labels[Lb.LogLabel].Text = "[Rozpoczęcie walki]";
        _labels[Lb.TurnLabel].Text = $"Ruch: {CombatSession.ActiveParticipant.Name}";
    ...
    private void GetNodes()
    {
        ...
        _labels[Lb.TurnLabel] = GetNode<Label>("%TurnLabel");
        _labels[Lb.LogLabel] = GetNode<Label>("%LogLabel");
    ...
    {
        _containers[Ct.ActionButtons].Visible = false;
    }
}
